...
void settingsDefault(int preset)
{
    ...
    if(preset == 0 || preset == 1)
    {
        ...
        setting_kfGlobalWeight=1.0f;   // original is 1.0. 0.3 is a balance between speed and accuracy. if tracking lost, set this para higher
...
int main( int argc, char** argv )
{
    ...
    */
    ...
    fullSystem->printResult("/home/mm/Downloads/stereoDSO_ws/src/stereo_dso_ros/examples/result.txt");
    delete undistorter;
    delete fullSystem;
